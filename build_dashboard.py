...
WITH base AS (
    ...
    WHERE r.last_version = TRUE
        ...
        AND CAST(dc.deadline AS DATE) <= CURRENT_DATE
...
function renderMensual(){
  ...
  krs.forEach(function(kr,ki){
    ...
    var invB=kr.inverted?'<span style="font-size:10px;background:#EDE9FE;color:#6D28D9;border-radius:4px;padding:1px 6px;margin-left:6px;font-weight:700;white-space:nowrap">↓ baja</span>':'';
    html+='<tr><td style="text-align:center;font-weight:700;color:#5B21B6;white-space:nowrap;padding:11px 8px">'+krNro(kr.label)+'</td><td class="td-kr">'+krDesc(kr.label)+invB+'</td><td style="text-align:center;font-weight:600;color:var(--muted);white-space:nowrap;padding:11px 6px">'+pesoPM[ki]+'</td>';
...
function renderProgreso(){
  ...
  krs.forEach(function(kr,ki){
    ...
    html+='<tr>';
    var invBp=kr.inverted?'<span style="font-size:10px;background:#EDE9FE;color:#6D28D9;border-radius:4px;padding:1px 6px;margin-left:6px;font-weight:700;white-space:nowrap">↓ baja</span>':'';
    html+='<td style="text-align:center;font-weight:700;color:#5B21B6;white-space:nowrap;padding:11px 8px">'+krNro(kr.label)+'</td><td class="td-kr">'+krDesc(kr.label)+invBp+'</td><td style="text-align:center;font-weight:600;color:var(--muted);white-space:nowrap;padding:11px 6px">'+pesoPP[ki]+'</td>';
  ...
  krs.forEach(function(kr){
    ...
    var invBb=kr.inverted?'<span style="font-size:10px;background:#EDE9FE;color:#6D28D9;border-radius:4px;padding:1px 6px;margin-left:6px;font-weight:700;white-space:nowrap">↓ baja</span>':'';
    html+='<span style="font-weight:700;color:#5B21B6;font-size:12px;margin-right:8px">'+krNro(kr.label)+'</span><span style="font-weight:600;font-size:13px">'+krDesc(kr.label)+invBb+'</span>';
